...
def ejecutar_importacion_horarios():
    ...
    # Abreviaciones de asignatura → nombre exacto en la BD
    ASIG_MAP = {
        'cea': 'CEA', 'crr': 'CRR', 'dee': 'DEE',
        'reli': 'Religión', 'religi': 'Religión',
        'english': 'Inglés', 'engl': 'Inglés',
        'euskera': 'Euskera',
        'mate': 'Mate', 'mates': 'Mate',
        'inguru': 'Inguru',
        'lengua': 'Lengua',
        'gh': 'Gimnasia', 'gizarte': 'Gimnasia',
        'musika': 'Música', 'musica': 'Música',
        'plastika': 'Plastika', 'plastica': 'Plastika',
        'tutor': 'Tutoretza', 'tutor.': 'Tutoretza',
        'frantsesa': 'Francés', 'frances': 'Francés', 'francés': 'Francés',
        'baloreak': 'Valores', 'balore': 'Valores', 'balore.': 'Valores',
        'irakur': 'Lectura Euskera', 'irakur.': 'Lectura Euskera',
        'lectura': 'Lectura Lengua', 'lectur.': 'Lectura Lengua',
    }
    ...
    HORARIOS = [
        # ── HH 3 URTE ──
        ('HH1','Lunes','9:00','CEA','JAIONE'), ('HH1','Martes','9:00','CEA','JAIONE'),
        ('HH1','Miércoles','9:00','CEA','JAIONE'), ('HH1','Jueves','9:00','CEA','JAIONE'),
        ('HH1','Viernes','9:00','CRR','JAIONE'),
        ('HH1','Lunes','10:00','RELI','KRIS'), ('HH1','Martes','10:00','CRR','JAIONE'),
        ('HH1','Miércoles','10:00','DEE','JAIONE'), ('HH1','Jueves','10:00','ENGLISH','NOE'),
        ('HH1','Viernes','10:00','CRR','JAIONE'),
        ('HH1','Lunes','11:30','DEE','JAIONE'), ('HH1','Martes','11:30','ENGLISH','NOE'),
        ('HH1','Miércoles','11:30','CEA','JAIONE'), ('HH1','Jueves','11:30','CRR','JAIONE'),
        ('HH1','Viernes','11:30','RELI','KRIS'),
        ('HH1','Lunes','14:30','CRR','JAIONE'), ('HH1','Martes','14:30','CRR','JAIONE'),
        ('HH1','Miércoles','14:30','CRR','JAIONE'), ('HH1','Jueves','14:30','CRR','JAIONE'),
        ('HH1','Viernes','14:30','CEA','JAIONE'),
        ('HH1','Lunes','15:30','CRR','JAIONE'), ('HH1','Martes','15:30','CRR','JAIONE'),
        ('HH1','Miércoles','15:30','CRR','JAIONE'), ('HH1','Jueves','15:30','CRR','JAIONE'),
        ('HH1','Viernes','15:30','DEE','JAIONE'),
        # ── HH 4 URTE ──
        ('HH2','Lunes','9:00','CRR','MARIA'), ('HH2','Martes','9:00','CEA','NATALIA'),
        ('HH2','Miércoles','9:00','CRR','MARIA'), ('HH2','Jueves','9:00','CRR','MARIA'),
        ('HH2','Viernes','9:00','CEA','NATALIA'),
        ('HH2','Lunes','10:00','CRR','MARIA'), ('HH2','Martes','10:00','CEA','NATALIA'),
        ('HH2','Miércoles','10:00','CRR','MARIA'), ('HH2','Jueves','10:00','CRR','MARIA'),
        ('HH2','Viernes','10:00','DEE','NATALIA'),
        ('HH2','Lunes','11:30','ENGLISH','NOE'), ('HH2','Martes','11:30','CEA','NATALIA'),
        ('HH2','Miércoles','11:30','CEA','NATALIA'), ('HH2','Jueves','11:30','DEE','NATALIA'),
        ('HH2','Viernes','11:30','ENGLISH','NOE'),
        ('HH2','Lunes','14:30','CRR','MARIA'), ('HH2','Martes','14:30','CRR','MARIA'),
        ('HH2','Miércoles','14:30','CRR','MARIA'), ('HH2','Jueves','14:30','CRR','MARIA'),
        ('HH2','Viernes','14:30','DEE','MARIA'),
        ('HH2','Lunes','15:30','CRR','MARIA'), ('HH2','Martes','15:30','RELI','KRIS'),
        ('HH2','Miércoles','15:30','RELI','KRIS'), ('HH2','Jueves','15:30','CRR','MARIA'),
        ('HH2','Viernes','15:30','CRR','MARIA'),
        # ── HH 5 URTE ──
        ('HH3','Lunes','9:00','CEA','KARMELE'), ('HH3','Martes','9:00','CEA','KARMELE'),
        ('HH3','Miércoles','9:00','CEA','KARMELE'), ('HH3','Jueves','9:00','DEE','KARMELE'),
        ('HH3','Viernes','9:00','CEA','KARMELE'),
        ('HH3','Lunes','10:00','CRR','KARMELE'), ('HH3','Martes','10:00','CRR','KARMELE'),
        ('HH3','Miércoles','10:00','DEE','KARMELE'), ('HH3','Jueves','10:00','CRR','KARMELE'),
        ('HH3','Viernes','10:00','CRR','KARMELE'),
        ('HH3','Lunes','11:30','RELI','KRISTINA'), ('HH3','Martes','11:30','CRR','KARMELE'),
        ('HH3','Miércoles','11:30','CEA','KARMELE'), ('HH3','Jueves','11:30','CRR','KARMELE'),
        ('HH3','Viernes','11:30','CRR','KARMELE'),
        ('HH3','Lunes','14:30','CRR','KARMELE'), ('HH3','Martes','14:30','ENGLISH','NOE'),
        ('HH3','Miércoles','14:30','RELI','KRISTINA'), ('HH3','Jueves','14:30','CRR','KARMELE'),
        ('HH3','Viernes','14:30','ENGLISH','NOE'),
        ('HH3','Lunes','15:30','CRR','KARMELE'), ('HH3','Martes','15:30','CRR','KARMELE'),
        ('HH3','Miércoles','15:30','CRR','KARMELE'), ('HH3','Jueves','15:30','DEE','KARMELE'),
        ('HH3','Viernes','15:30','CEA','KARMELE'),
        # ── LH 1.A ──
        ('LH1','Lunes','9:00','EUSKERA','EVA'), ('LH1','Martes','9:00','EUSKERA','EVA'),
        ('LH1','Miércoles','9:00','ENGLISH','AZK'), ('LH1','Jueves','9:00','MATE','EVA'),
        ('LH1','Viernes','9:00','MATE','EVA'),
        ('LH1','Lunes','10:00','ENGLISH','AZK'), ('LH1','Martes','10:00','LENGUA','KRIS'),
        ('LH1','Miércoles','10:00','EUSKERA','EVA'), ('LH1','Jueves','10:00','ENGLISH','AZK'),
        ('LH1','Viernes','10:00','INGURU','KRIS'),
        ('LH1','Lunes','11:30','GH','IÑIGO'), ('LH1','Martes','11:30','INGURU','KRIS'),
        ('LH1','Miércoles','11:30','LENGUA','MARIA'), ('LH1','Jueves','11:30','LENGUA','KRIS'),
        ('LH1','Viernes','11:30','GH','IÑIGO'),
        ('LH1','Lunes','14:30','LENGUA','KRIS'), ('LH1','Martes','14:30','RELI','KRIS'),
        ('LH1','Miércoles','14:30','MATE','EVA'), ('LH1','Jueves','14:30','INGURU','KRIS'),
        ('LH1','Viernes','14:30','EUSKERA','EVA'),
        ('LH1','Lunes','15:30','MUSIKA','KRIS'), ('LH1','Martes','15:30','MATE','EVA'),
        ('LH1','Miércoles','15:30','PLASTIKA','EVA'), ('LH1','Jueves','15:30','RELI','KRIS'),
        ('LH1','Viernes','15:30','TUTOR','EVA'),
        # ── LH 2.A ──
        ('LH2','Lunes','9:00','EUSKERA','MG'), ('LH2','Martes','9:00','EUSKERA','MG'),
        ('LH2','Miércoles','9:00','MUSIKA','KRIS'), ('LH2','Jueves','9:00','ENGLISH','AZK'),
        ('LH2','Viernes','9:00','MATE','MG'),
        ('LH2','Lunes','10:00','GH','ARRIETA'), ('LH2','Martes','10:00','MATE','MG'),
        ('LH2','Miércoles','10:00','ENGLISH','AZK'), ('LH2','Jueves','10:00','EUSKERA','MG'),
        ('LH2','Viernes','10:00','GH','ARRIETA'),
        ('LH2','Lunes','11:30','ENGLISH','AZK'), ('LH2','Martes','11:30','LENGUA','EVA'),
        ('LH2','Miércoles','11:30','LENGUA','EVA'), ('LH2','Jueves','11:30','RELI','MARIA'),
        ('LH2','Viernes','11:30','PLASTIKA','AZK'),
        ('LH2','Lunes','14:30','MATE','MG'), ('LH2','Martes','14:30','INGURU','MG'),
        ('LH2','Miércoles','14:30','MATE','MG'), ('LH2','Jueves','14:30','LENGUA','EVA'),
        ('LH2','Viernes','14:30','INGURU','MG'),
        ('LH2','Lunes','15:30','LENGUA','EVA'), ('LH2','Martes','15:30','INGURU','MG'),
        ('LH2','Miércoles','15:30','RELI','MARIA'), ('LH2','Jueves','15:30','GH','ARRIETA'),
        ('LH2','Viernes','15:30','TUTOR','MG'),
        # ── LH 3.A ──
        ('LH3','Lunes','9:00','EUSKERA','UNAI'), ('LH3','Martes','9:00','EUSKERA','UG'),
        ('LH3','Miércoles','9:00','ENGLISH','EVA'), ('LH3','Jueves','9:00','EUSKERA','UG'),
        ('LH3','Viernes','9:00','EUSKERA','UG'),
        ('LH3','Lunes','10:00','MATE','UNAI'), ('LH3','Martes','10:00','MATE','UNAI'),
        ('LH3','Miércoles','10:00','RELI','ARRIETA'), ('LH3','Jueves','10:00','MATE','UNAI'),
        ('LH3','Viernes','10:00','LENGUA','IMA'),
        ('LH3','Lunes','11:30','PLASTIKA','EVA'), ('LH3','Martes','11:30','INGURU','UG'),
        ('LH3','Miércoles','11:30','MATE','UNAI'), ('LH3','Jueves','11:30','LENGUA','IMA'),
        ('LH3','Viernes','11:30','GH','UNAI'),
        ('LH3','Lunes','14:30','RELI','ARRIETA'), ('LH3','Martes','14:30','ENGLISH','EVA'),
        ('LH3','Miércoles','14:30','INGURU','UNAI'), ('LH3','Jueves','14:30','INGURU','UG'),
        ('LH3','Viernes','14:30','MUSIKA','KRIS'),
        ('LH3','Lunes','15:30','LENGUA','IMA'), ('LH3','Martes','15:30','GH','UNAI'),
        ('LH3','Miércoles','15:30','INGURU','UNAI'), ('LH3','Jueves','15:30','ENGLISH','EVA'),
        ('LH3','Viernes','15:30','TUTOR','UNAI'),
        # ── LH 4.A ──
        ('LH4','Lunes','9:00','EUSKERA','IM'), ('LH4','Martes','9:00','EUSKERA','IM'),
        ('LH4','Miércoles','9:00','INGURU','UNAI'), ('LH4','Jueves','9:00','MATE','IMA'),
        ('LH4','Viernes','9:00','MATE','IMA'),
        ('LH4','Lunes','10:00','ENGLISH','EVA'), ('LH4','Martes','10:00','LENGUA','IÑIG'),
        ('LH4','Miércoles','10:00','MUSIKA','KRIS'), ('LH4','Jueves','10:00','ENGLISH','EVA'),
        ('LH4','Viernes','10:00','LENGUA','IÑI'),
        ('LH4','Lunes','11:30','MATE','IMANOL'), ('LH4','Martes','11:30','MATE','IMAN'),
        ('LH4','Miércoles','11:30','RELI','MIRIAM'), ('LH4','Jueves','11:30','LENGUA','IÑIG'),
        ('LH4','Viernes','11:30','ENGLISH','EV'),
        ('LH4','Lunes','14:30','INGURU','UNAI'), ('LH4','Martes','14:30','PLASTIKA','IM'),
        ('LH4','Miércoles','14:30','EUSKERA','IMA'), ('LH4','Jueves','14:30','RELI','MIRIAM'),
        ('LH4','Viernes','14:30','GH','IMANOL'),
        ('LH4','Lunes','15:30','INGURU','UNAI'), ('LH4','Martes','15:30','GH','IMA'),
        ('LH4','Miércoles','15:30','LENGUA','IÑIGO'), ('LH4','Jueves','15:30','EUSKERA','IM'),
        ('LH4','Viernes','15:30','TUTOR','IMA'),
        # ── LH 5.A ──
        ('LH5','Lunes','9:00','MATE','JJ'), ('LH5','Martes','9:00','MATE','JJ'),
        ('LH5','Miércoles','9:00','ENGLISH','JJ'), ('LH5','Jueves','9:00','LENGUA','IÑI'),
        ('LH5','Viernes','9:00','MUSIKA','KRIS'),
        ('LH5','Lunes','10:00','INGURU','JJ'), ('LH5','Martes','10:00','FRANCÉS','IM'),
        ('LH5','Miércoles','10:00','EUSKERA','UNAI'), ('LH5','Jueves','10:00','ENGLISH','JJ'),
        ('LH5','Viernes','10:00','EUSKERA','UG'),
        ('LH5','Lunes','11:30','RELI','MIRIAM'), ('LH5','Martes','11:30','INGURU','JJ'),
        ('LH5','Miércoles','11:30','LENGUA','IÑIGO'), ('LH5','Jueves','11:30','EUSKERA','UG'),
        ('LH5','Viernes','11:30','RELI','MIRIAM'),
        ('LH5','Lunes','14:30','LENGUA','IÑIGO'), ('LH5','Martes','14:30','EUSKERA','UG'),
        ('LH5','Miércoles','14:30','INGURU','JJ'), ('LH5','Jueves','14:30','PLASTIKA','IRI'),
        ('LH5','Viernes','14:30','GH','JUANJO'),
        ('LH5','Lunes','15:30','GH','JUANJO'), ('LH5','Martes','15:30','LENGUA','IÑIG'),
        ('LH5','Miércoles','15:30','INGURU','JJ'), ('LH5','Jueves','15:30','MATE','JJ'),
        ('LH5','Viernes','15:30','TUTOR','JJ'),
        # ── LH 6.A ──
        ('LH6','Lunes','9:00','EUSKERA','JOS'), ('LH6','Martes','9:00','LENGUA','IÑIG'),
        ('LH6','Miércoles','9:00','MATE','JOSE'), ('LH6','Jueves','9:00','EUSKERA','JOS'),
        ('LH6','Viernes','9:00','EUSKERA','JO'),
        ('LH6','Lunes','10:00','LENGUA','IÑIG'), ('LH6','Martes','10:00','MATE','JOSEB'),
        ('LH6','Miércoles','10:00','ENGLISH','IRION'), ('LH6','Jueves','10:00','MUSIKA','KRIS'),
        ('LH6','Viernes','10:00','RELI','MIRIAM'),
        ('LH6','Lunes','11:30','INGURU','JOSEB'), ('LH6','Martes','11:30','EUSKERA','JO'),
        ('LH6','Miércoles','11:30','BALOREAK','JOSEB'), ('LH6','Jueves','11:30','RELI','MIRIAM'),
        ('LH6','Viernes','11:30','ENGLISH','IRI'),
        ('LH6','Lunes','14:30','FRANTSESA','IM'), ('LH6','Martes','14:30','INGURU','JO'),
        ('LH6','Miércoles','14:30','PLASTIKA','JOSE'), ('LH6','Jueves','14:30','LENGUA','IÑI'),
        ('LH6','Viernes','14:30','GH','JOSEBA'),
        ('LH6','Lunes','15:30','BALOREAK','JOSE'), ('LH6','Martes','15:30','INGURU','JO'),
        ('LH6','Miércoles','15:30','GH','JOSEBA'), ('LH6','Jueves','15:30','ENGLISH','IRIO'),
        ('LH6','Viernes','15:30','TUTOR','JOS'),
    ]
...
def generar_horario_automatico():
    ...
    # ── FASE 2: Random restarts — solo reglas del usuario ────────────────
    # Algoritmo intencionalmente simple:
    #   - Orden de items: aleatorio en cada reinicio (sin heurísticas)
    #   - Selección de slot: aleatorio entre los válidos (sin heurísticas)
    #   - Validez: SOLO las reglas del usuario (no doble-ocupación prof/clase,
    #     rp_excluir_franja, reglas_max_dia). Nada más inventado.
    #   - Items c/p (consecutivos/pareados): greedy clásico, son pocos.
    # Si con esto sigue fallando → los datos están sobre-restringidos.
    ...
    # ── 2b) N-items: random restarts, solo reglas del usuario ────────────
    # Algoritmo intencionalmente simple:
    #   - Orden aleatorio en cada reinicio (sin heurísticas de slack)
    #   - Slot seleccionado al azar entre los válidos (sin scoring)
    #   - Validez: SOLO reglas del usuario:
    #       · No doble-ocupación prof (p_occ_local)
    #       · No doble-ocupación clase (c_occ_local)
    #       · rp_excluir_franja (franjas excluidas del prof)
    #       · reglas_max_dia (máx. ocurrencias por asignatura/día/clase)
    #   - gp_occ / gc_occ son los slots FIJOS (manual + fijar + c/p)
    # Si con esto sigue fallando → los datos están sobre-restringidos.

    n_items_list = [(item[1], item[2], item[3])
    ...
    while _time.time() - _bt_start < BT_TIMEOUT:
        ...
        p_occ_local = {pid: set(s) for pid, s in gp_occ.items()}
        c_occ_local = {cid: set(s) for cid, s in gc_occ.items()}
        d_cnt_local = defaultdict(int)

        placed_iter = []
        for li in indices:
            cid, aid, pid = n_items_list[li]
            mx = reglas_max_dia.get(aid)
            valid = [s for s in slots_all
                     if s not in p_occ_local.get(pid, set())
                     and s not in c_occ_local.get(cid, set())
                     and pid not in rp_excluir_franja.get(s, ())
                     and (not mx or d_cnt_local[(cid, aid, s[0])] < mx)]
            if valid:
                slot = random.choice(valid)
                p_occ_local.setdefault(pid, set()).add(slot)
                c_occ_local.setdefault(cid, set()).add(slot)
                d_cnt_local[(cid, aid, slot[0])] += 1
                placed_iter.append((cid, aid, pid, slot[0], slot[1], None, None))

        with _gen_lock:
            _gen_estado['intentos'] = iteration
            _gen_estado['mejor_fallos'] = N - best_n_placed

        if len(placed_iter) > best_n_placed:
            best_n_placed = len(placed_iter)
            best_placed_n = placed_iter[:]
            with _gen_lock:
                _gen_estado['mejor_fallos'] = N - best_n_placed
            if best_n_placed == N:
                break

    best_assignments = placed_base + cp_placed + best_placed_n
    best_fallos = fallos_base + cp_fallos + (N - best_n_placed)
...
def _asignar_grupos_trabajo():
    ...
    for grupo in grupos:
        ...
        # IMPORTANTE: descontar slots manuales ya existentes para no
        # duplicar cuando el usuario tiene horas bloqueadas (🔒).
        for pid in prof_ids:
            m = miembro_map[pid]
            n_slots = math.ceil(m.horas_semanales)
            tiene_fraccion = (m.horas_semanales % 1) >= 0.5

            # Slots manuales existentes para este miembro en este grupo
            n_existing = SlotComplementaria.query.filter_by(
                profesor_id=pid, grupo_id=grupo.id, es_manual=True
            ).count()
            prof_slots_grupo[pid] += n_existing  # contar en el total

            n_new = max(0, n_slots - n_existing)
            for i, (dia, franja) in enumerate(shared_slots[:n_new]):
                es_ultimo = (i == n_new - 1)
...
def init_db():
    ...
    migrations = [
        ...
        # Columnas que pueden faltar en producción
        'ALTER TABLE guardia ADD COLUMN aula VARCHAR(50)',
        'ALTER TABLE guardia ADD COLUMN dia_semana VARCHAR(20)',
        'ALTER TABLE guardia ADD COLUMN completada BOOLEAN DEFAULT FALSE',
        'ALTER TABLE guardia ADD COLUMN estado VARCHAR(20) DEFAULT \'pendiente\'',
        'ALTER TABLE guardia ADD COLUMN motivo_ausencia VARCHAR(200)',
        'ALTER TABLE guardia ADD COLUMN notas TEXT',
        'ALTER TABLE ausencia ADD COLUMN franjas_afectadas TEXT DEFAULT \'todas\'',
        'ALTER TABLE ausencia ADD COLUMN aprobada BOOLEAN DEFAULT TRUE',
        'ALTER TABLE ausencia ADD COLUMN fecha_fin DATE',
        'ALTER TABLE ausencia ADD COLUMN reportada_por INTEGER REFERENCES profesor(id)',
        'ALTER TABLE profesor ADD COLUMN aula_tutoria VARCHAR(50)',
        "ALTER TABLE profesor ADD COLUMN aulas_bloqueadas TEXT DEFAULT '[]'",
        'ALTER TABLE profesor ADD COLUMN de_baja BOOLEAN DEFAULT FALSE',
        'ALTER TABLE profesor ADD COLUMN fecha_baja DATE',
        'ALTER TABLE profesor ADD COLUMN fecha_vuelta DATE',
        'ALTER TABLE profesor ADD COLUMN activo BOOLEAN DEFAULT TRUE',
        'ALTER TABLE profesor ADD COLUMN es_especialista BOOLEAN DEFAULT FALSE',
        'ALTER TABLE indisponibilidad ADD COLUMN recurrente BOOLEAN DEFAULT FALSE',
        'ALTER TABLE indisponibilidad ADD COLUMN fecha_especifica DATE',
        'ALTER TABLE indisponibilidad ADD COLUMN activa BOOLEAN DEFAULT TRUE',
        'ALTER TABLE horario_profesor ADD COLUMN asignatura VARCHAR(100)',
        'ALTER TABLE horario_profesor ADD COLUMN tiene_clase BOOLEAN DEFAULT FALSE',
    ]
